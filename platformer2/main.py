...
def reset_level(level):
    ...
    if os.path.exists(f"levels\level{level}_data"):
        ...
        world = World(world_data, blob_group, lava_group, exit_door_group, coin_group)
        return  world
...
while running:
    ...
    if main_menu:
        ...
        # draw_grid(screen)
        world.draw(screen)
        game_status =player.update(screen, world.tile_list, blob_group, lava_group,exit_door_group,game_status, coin_group)
